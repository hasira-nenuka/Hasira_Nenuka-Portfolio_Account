...
import { P as PortfolioPage, e as CERTIFICATIONS, d as SOCIALS } from "./PortfolioPage-D4CHDhWE.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { i as Award, E as ExternalLink, r as Eye, I as Images, X, s as Maximize2 } from "../_libs/lucide-react.mjs";
...
function Certifications() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: CERTIFICATIONS.map((c, i) => {
            ...
            motion.div,
            {
              ...
              children: galleryTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CertificationCardContent, { title: c.title, org: c.org, year: c.year, isClickable: true })
                }
              ) : isCourseworkProjects ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "surface group h-full rounded-2xl p-6 text-left card-hover hover:-translate-y-1 hover:border-[var(--brand)]/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CertificationCardContent, { title: c.title, org: c.org, year: c.year }) })
            },
            c.title
          );
        }) }),
...
function CertificationCardContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: org }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center justify-between gap-3 border-t border-white/10 pt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-[var(--brand)] font-medium", children: year }),
      actionIcon === "external" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "size-4 text-muted-foreground", "aria-hidden": "true" }) : null,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 xl:grid-cols-3 gap-5 pb-8", children: gallery.certificates.map((certificate) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex items-center justify-between gap-3 px-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: certificate.title }),
