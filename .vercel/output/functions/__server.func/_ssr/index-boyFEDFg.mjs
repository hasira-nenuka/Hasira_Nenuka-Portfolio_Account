...
import { P as PortfolioPage, H as HIGHLIGHTS, d as SOCIALS, f as STATS } from "./PortfolioPage-D83AEUa4.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { j as Sparkles, m as CircleCheck, v as ArrowRight, M as Mail, w as Download, d as Github, o as Linkedin, p as MapPin, x as SquareTerminal, b as ShieldCheck, y as MonitorDot, z as Workflow } from "../_libs/lucide-react.mjs";
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "max-w-4xl font-bold leading-[1.04]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block bg-gradient-to-r from-white via-[var(--brand-2)] to-[var(--brand)] bg-clip-text font-display text-[clamp(3.6rem,14vw,7.5rem)] font-black leading-[0.88] tracking-[0.012em] text-transparent drop-shadow-[0_16px_38px_oklch(0.88_0.17_77_/_0.3)] sm:tracking-[0.018em]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "Hasira" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "Nenuka" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 block bg-[image:var(--gradient-brand)] bg-[length:180%_180%] bg-clip-text text-3xl text-transparent animate-gradient-pan sm:whitespace-nowrap sm:text-4xl md:text-5xl", children: "Full-Stack Developer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 block text-2xl text-foreground/92 sm:whitespace-nowrap sm:text-3xl md:text-4xl", children: "Building Modern Web Applications" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-2xl text-lg font-medium text-foreground/90 md:text-xl", children: "Information Technology undergraduate passionate about building modern full-stack applications with clean code, scalable backend systems, and user-friendly experiences." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-2xl leading-7 text-muted-foreground", children: "I develop web applications using React, Spring Boot, Node.js, and SQL databases while strengthening my skills in software testing, automation, Agile development, and project management. I enjoy building practical software solutions that solve real-world problems through clean design and efficient implementation." }),
